...
class EducationClient(object):
    ...
    def add(self, usn,name,marks):
        '
        self._address=_hash(FAMILY_NAME.encode('utf-8'))[0:6]+ \
                       _hash(usn.encode('utf-8'))[0:64]
        return self._wrap_and_send("add", name,marks, wait=10)
    ...
    def _wrap_and_send(self, usn, name, wait=None):
